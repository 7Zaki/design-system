  ...
  'relative flex gap-3 rounded-lg border p-4 text-sm',
  {
    variants: {
      variant: {
        ...
        success: 'border-green-200   bg-success-50  text-green-800',
        warning: 'border-yellow-200  bg-warning-50  text-yellow-800',
        danger:  'border-red-200     bg-danger-50   text-red-800',
